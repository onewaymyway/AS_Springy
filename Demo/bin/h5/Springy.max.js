...
(function(window,document,Laya){
	...
	*/
	...
	var Edge=(function(){
		...
		__class(Edge,'oneway.springy.Edge');
		return Edge;
	})()
	...
	*/
	...
	var Graph=(function(){
		...
		__class(Graph,'oneway.springy.Graph');
		var __proto=Graph.prototype;
		...
		__proto.addNodes=function(__args){
			var args=arguments;
		...
		__proto.addEdges=function(__args){
			var args=arguments;
			for (var i=0;i < args.length;i++){
				var e=args[i];
		...
		__proto.newNode=function(data){
			var node=new Node(this.nextNodeId++,data);
			this.addNode(node);
			return node;
		}

		__proto.newEdge=function(source,target,data){
			var edge=new Edge(this.nextEdgeId++,source,target,data);
			this.addEdge(edge);
			return edge;
		}

		__proto.loadJSON=function(json){
		...
		__proto.getEdges=function(node1,node2){
		...
		__proto.detachNode=function(node){
		...
		__proto.removeEdge=function(edge){
		...
		__proto.merge=function(data){
			...
			data.edges.forEach(function(e){
				...
				var to=nodes[e.to];
				var id=(e.directed)? (id=e.type+"-"+from.id+"-"+to.id):(from.id < to.id)
		...
		__proto.filterNodes=function(fn){
		...
		__proto.filterEdges=function(fn){
			var tmpEdges=this.edges.slice();
			tmpEdges.forEach(function(e){
				if (!fn(e)){
					this.removeEdge(e);
		...
		__proto.addGraphListener=function(obj){
	...
	*@author ww
	*/
	//class oneway.springy.layout.ForceDirected
	var ForceDirected=(function(){
		function ForceDirected(graph,stiffness,repulsion,damping,minEnergyThreshold,maxSpeed){
			...
			this._started=false;
			this._stop=false;
			(minEnergyThreshold===void 0)&& (minEnergyThreshold=0.01);
			(maxSpeed===void 0)&& (maxSpeed=0);
			this.graph=graph;
			this.stiffness=stiffness;
			this.repulsion=repulsion;
			this.damping=damping;
			this.minEnergyThreshold=minEnergyThreshold || 0.01;
			this.maxSpeed=maxSpeed || Infinity;
			this.nodePoints={};
			this.edgeSprings={};
		}

		__class(ForceDirected,'oneway.springy.layout.ForceDirected');
		var __proto=ForceDirected.prototype;
		// keep track of springs associated with edges
		__proto.point=function(node){
		...
		__proto.eachNode=function(callback){
			var t=this;
		...
		__proto.eachEdge=function(callback){
			var t=this;
		...
		__proto.eachSpring=function(callback){
			var t=this;
			this.graph.edges.forEach(function(e){
		...
		__proto.applyCoulombsLaw=function(){
		...
		__proto.applyHookesLaw=function(){
		...
		__proto.attractToCentre=function(){
		...
		__proto.updateVelocity=function(timestep){
			this.eachNode(function(node,point){
		...
		__proto.updatePosition=function(timestep){
			this.eachNode(function(node,point){
				point.p=point.p.add(point.v.multiply(timestep));
			});
		}

		__proto.totalEnergy=function(timestep){
			(timestep===void 0)&& (timestep=0.03);
			var energy=0.0;
			this.eachNode(function(node,point){
		...
		__proto.start=function(render,onRenderStop,onRenderStart){
			this.render=render;
		...
		__proto.tick=function(timestep){
		...
		__proto.getBoundingBox=function(){
	...
	*/
	...
	var Node=(function(){
		...
		__class(Node,'oneway.springy.Node');
		return Node;
	})()
	...
	*/
	...
	var Point=(function(){
		function Point(position,mass){
			...
			this.p=position;
			this.m=mass;
			this.v=new SpringVector(0,0);
			this.a=new SpringVector(0,0);
		}

		__class(Point,'oneway.springy.Point');
		var __proto=Point.prototype;
		// acceleration
		__proto.applyForce=function(force){
	...
	*/
	...
	var Spring=(function(){
		...
		__class(Spring,'oneway.springy.Spring');
		Spring.isEmpty=function(obj){
			for (var k in obj){
		...
		Spring.requestAnimationFrame=null
		return Spring;
	})()
	...
	*@author ww
	*/
	//class oneway.springy.SpringVector
	var SpringVector=(function(){
		function SpringVector(x,y){
			this.x=NaN;
			this.y=NaN;
			this.x=x;
			this.y=y;
		...
		__class(SpringVector,'oneway.springy.SpringVector');
		var __proto=SpringVector.prototype;
		...
		__proto.multiply=function(n){
			return new SpringVector(this.x *n,this.y *n);
		}

		__proto.divide=function(n){
			return new SpringVector((this.x / n)|| 0,(this.y / n)|| 0);
		}

		// Avoid divide by zero errors..
		__proto.magnitude=function(){
			return Math.sqrt(this.x *this.x+this.y *this.y);
		}

		__proto.normal=function(){
			return new SpringVector(-this.y,this.x);
		}

		__proto.normalise=function(){
			return this.divide(this.magnitude());
		}

		SpringVector.random=function(){
	...
	var Graphics=(function(){
		...
		*/
		__proto.fillTexture=function(tex,x,y,width,height,type,offset){
			...
			if (!tex)return;
			var args=[tex,x,y,width,height,type,offset || Point$1.EMPTY,{}];
			if (!tex.loaded){
				tex.once("loaded",this,this._textureLoaded,[tex,args]);
			}
	...
	*/
	...
	var MouseManager=(function(){
		function MouseManager(){
			...
			this._point=new Point$1();
			this._rect=new Rectangle();
			this._prePoint=new Point$1();
	...
	*/
	...
	var Bezier=(function(){
		function Bezier(){
			this._controlPoints=[new Point$1(),new Point$1(),new Point$1()];
		...
		*/
		__proto.getBezierPoints=function(pList,inSertCount,count){
			...
			while (this._controlPoints.length <=count){
				this._controlPoints.push(new Point$1());
			}
	...
	*/
	...
	var GrahamScan=(function(){
		...
		GrahamScan._getPoints=function(count,tempUse,rst){
			...
			while (GrahamScan._mPointList.length < count)GrahamScan._mPointList.push(new Point$1());
			if (!rst)rst=[];
			rst.length=0;
			if (tempUse){
	...
	*/
	...
	var Point$1=(function(){
		...
		__class(Point,'laya.maths.Point',null,'Point$1');
		var __proto=Point.prototype;
		/**
	...
	var Rectangle=(function(){
		...
		*/
		...
		Rectangle._getWrapRec=function(pointList,rst){
			...
			var i,len=pointList.length,minX,maxX,minY,maxY,tPoint=Point$1.TEMP;
			minX=minY=99999;
			maxX=maxY=-minX;
			for (i=0;i < len;i+=2){
	...
	*/
	...
	var HitArea=(function(){
		...
		*/
		...
		HitArea._cmds=[];
		__static(HitArea,
		['_rec',function(){return this._rec=new Rectangle();},'_ptPoint',function(){return this._ptPoint=new Point$1();}
		]);
		return HitArea;
	})()
	...
	*/
	...
	var Utils=(function(){
		...
		Utils.getGlobalRecByPoints=function(sprite,x0,y0,x1,y1){
			var newLTPoint;
			newLTPoint=new Point$1(x0,y0);
			newLTPoint=sprite.localToGlobal(newLTPoint);
			var newRBPoint;
			newRBPoint=new Point$1(x1,y1);
	...
	*/
	...
	var Node$1=(function(_super){
		...
		__class(Node,'laya.display.Node',_super,'Node$1');
	...
	var Sprite=(function(_super){
		...
		*/
		__proto.hitTestPoint=function(x,y){
			var point=this.globalToLocal(Point$1.TEMP.setTo(x,y));
			x=point.x;
			y=point.y;
		...
		__proto.getMousePoint=function(){
			return this.globalToLocal(Point$1.TEMP.setTo(Laya.stage.mouseX,Laya.stage.mouseY));
		}
		...
		*/
		__proto.typeset=function(){
			...
			if (this.checkEnabledViewportOrNot())
				this._clipPoint || (this._clipPoint=new Point$1(0,0));
			else
			this._clipPoint=null;
	...
	*/
	...
	var Stage=(function(_super){
		...
		*/
		...
		/**@inheritDoc */
		__proto.getMousePoint=function(){
			return Point$1.TEMP.setTo(this.mouseX,this.mouseY);
		}
